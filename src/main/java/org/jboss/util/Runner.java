...
public class Runner {
  ...
  private static final String PROJECT_DIR = "echo-api";
  private static final String PROJECT_JAVA_DIR = PROJECT_DIR + "/src/main/java/";

  public static void runClusteredExample(Class clazz) {
    runExample(PROJECT_JAVA_DIR, clazz, new VertxOptions().setClustered(true), null);
  }

  public static void runExample(Class clazz) {
    runExample(PROJECT_JAVA_DIR, clazz, new VertxOptions().setClustered(false), null);
  }

  public static void runExample(Class clazz, DeploymentOptions options) {
    runExample(PROJECT_JAVA_DIR, clazz, new VertxOptions().setClustered(false), options);
  }
